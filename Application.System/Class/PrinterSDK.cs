...
namespace Application.System.Class
{
    public static class PrinterSDK
    {
        [DllImport("printer.sdk.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto)]
        public static extern int SetCodePage(IntPtr intPtr, int codePage);

        [DllImport("printer.sdk.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto)]
        public static extern int SetCodePageForArabic(IntPtr intPtr, int codePage);
